...
def hello():
    ...
    image = cv2.imread(r"C:\Users\Adit Shah\Desktop\Python\factoryIntelligence\examples\Photo(1).jpg")
    orig = image.copy()
    ...
    model = load_model(r"C:\Users\Adit Shah\Desktop\Python\factoryIntelligence\Factory_GlovesDetection.model")
    ...
    cur.execute("INSERT INTO worker_objectdetection(img_name,img_path,Gloves) VALUES (%s,%s,%s)",
                ["1.jpg", path, label])
