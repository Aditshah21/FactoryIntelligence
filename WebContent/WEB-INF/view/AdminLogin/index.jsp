...
<head>
    ...
    <link href="UserResources/css/perfect-scrollbar.css" rel="stylesheet">
    <!-- This page CSS -->
    <!-- chartist CSS -->
    <link href="UserResources/css/chartist.min.css" rel="stylesheet">
    <link href="UserResources/css/chartist-plugin-tooltip.css" rel="stylesheet">
    <!--c3 CSS -->
    <link href="UserResources/css/c3.min.css" rel="stylesheet">
    <!--Toaster Popup message CSS -->
    <link href="UserResources/css/jquery.toast.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="UserResources/css/style.css" rel="stylesheet">
    <!-- Dashboard 1 Page CSS -->
    <link href="UserResources/css/dashboard1.css" rel="stylesheet">
...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="UserResources/images/logo-icon.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="UserResources/images/logo-light-icon.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="UserResources/images/logo-text.png" alt="homepage" class="dark-logo" />
                         <!-- Light Logo text -->    
                         <img src="UserResources/images/logo-light-text.png" class="light-logo" alt="homepage" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="UserResources/images/1.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="UserResources/images/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Sonu Nigam</h5> <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="UserResources/images/3.jpg" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Arijit Sinh</h5> <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="UserResources/images/4.jpg" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:02 AM</span> </div>
                                            </a>
                                        </div>
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="UserResources/images/img1.jpg" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="UserResources/images/img2.jpg" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="UserResources/images/img3.jpg" alt="Third slide"></div>
                                                </div>
                                            </div>
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="UserResources/images/1.jpg" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="UserResources/images/1.jpg" alt="user"></div>
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-profile"> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><img src="UserResources/images/profile.png" alt="user" /><span class="hide-menu">Steave Jobs </span></a>
            ...
            <div class="container-fluid r-aside">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block">
                                    <div class="m-r-20 align-self-center"><span class="lstick m-r-20"></span><img src="UserResources/images/income.png" alt="Income" /></div>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block">
                                    <div class="m-r-20 align-self-center"><span class="lstick m-r-20"></span><img src="UserResources/images/expense.png" alt="Income" /></div>
                                    <div class="align-self-center">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block">
                                    <div class="m-r-20 align-self-center"><span class="lstick m-r-20"></span><img src="UserResources/images/assets.png" alt="Income" /></div>
                                    <div class="align-self-center">
                                ...
                                <div class="table-responsive m-t-20 no-wrap">
                                    <table class="table vm no-th-brd pro-of-month">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="active">
                                                <td><span class="round"><img src="UserResources/images/2.jpg" alt="user" width="50"></span></td>
                                                <td>
                            ...
                            <div class="activity-box">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="activity-item">
                                        <div class="round m-r-20"><img src="UserResources/images/2.jpg" alt="user" width="50" /></div>
                                        <div class="m-t-10">
                                            ...
                                            <table class="table vm b-0 m-b-0">
                                                <tr>
                                                    <td class="m-r-10 b-0"><img src="UserResources/images/zip.png" alt="user" /></td>
                                                    <td class="b-0">
                                    ...
                                    <!-- Activity item-->
                                    <div class="activity-item">
                                        <div class="round m-r-20"><img src="UserResources/images/3.jpg" alt="user" width="50" /></div>
                                        <div class="m-t-10">
                                            ...
                                            <span class="image-list m-t-10">
                                                <a href="javascript:void(0)"><img src="UserResources/images/1.jpg" class="img-circle" alt="user" width="40" /></a>
                                                <a href="javascript:void(0)"><img src="UserResources/images/4.jpg" class="img-circle" alt="user" width="40" /></a>
                                                <a href="javascript:void(0)"><img src="UserResources/images/5.jpg" class="img-circle" alt="user" width="40" /></a>
                                                <a href="javascript:void(0)"><img src="UserResources/images/6.jpg" class="img-circle" alt="user" width="40" /></a>
                                ...
                                <div class="card-body">
                                    <!-- Activity item-->
                                    <div class="activity-item">
                                        <div class="round m-r-20"><img src="UserResources/images/4.jpg" alt="user" width="50" /></div>
                                        <div class="m-t-10">
                                            <h5 class="m-b-0 font-medium">David R. Jones  <span class="text-muted font-14 m-l-10">| &nbsp; 6:30 PM</span></h5>
                                            <h6 class="text-muted">uploaded this file </h6>
                                            <span>
                                                <a href="javascript:void(0)" class="m-r-10"><img src="UserResources/images/img1.jpg" alt="user" width="60"></a>
                                                <a href="javascript:void(0)" class="m-r-10"><img src="UserResources/images/img2.jpg" alt="user" width="60"></a>
                                                <a href="javascript:void(0)" class="m-r-10"><img src="UserResources/images/img3.jpg" alt="user" width="60"></a>
                                            </span>
                                        </div>
                                    </div>
                                    <!-- Activity item-->
                                    <!-- Activity item-->
                                    <div class="activity-item">
                                        <div class="round m-r-20"><img src="UserResources/images/6.jpg" alt="user" width="50" /></div>
                                        <div class="m-t-10">
                                    ...
                                    <!-- Activity item-->
                                    <div class="activity-item">
                                        <div class="round m-r-20"><img src="UserResources/images/7.jpg" alt="user" width="50" /></div>
                                        <div class="m-t-10">
                                            <h5 class="m-b-0 font-medium">David R. Jones  <span class="text-muted font-14 m-l-10">| &nbsp; 6:30 PM</span></h5>
                                            <h6 class="text-muted">uploaded this file </h6>
                                            <p>It has survived not only five centuries</p>
                                            <span>
                                                <a href="javascript:void(0)" class="m-r-10"><img src="UserResources/images/img5.jpg" alt="user" width="60"></a>
                                                <a href="javascript:void(0)" class="m-r-10"><img src="UserResources/images/img6.jpg" alt="user" width="60"></a>
                                                <a href="javascript:void(0)" class="m-r-10"><img src="UserResources/images/img4.jpg" alt="user" width="60"></a>
                                            </span>
                                        </div>
                                    </div>
                                    <!-- Activity item-->
                    ...
                    <div class="col-lg-5 col-xlg-4">
                        <div class="card">
                            <div class="card-body little-profile text-center">
                                <div class="pro-img m-t-20"><img src="UserResources/images/4.jpg" alt="user"></div>
                ...
                <div class="row">
                                ...
                                <div class="to-do-widget m-t-20">
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item" data-role="task">
                                            ...
                                            <ul class="assignedto">
                                                <li><img src="UserResources/images/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li><img src="UserResources/images/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li><img src="UserResources/images/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li><img src="UserResources/images/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item" data-role="task">
                                            <div class="checkbox checkbox-info">
                                        ...
                                        <li class="list-group-item" data-role="task">
                                            ...
                                            <ul class="assignedto">
                                                <li><img src="UserResources/images/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Steave"></li>
                                                <li><img src="UserResources/images/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Jessica"></li>
                                                <li><img src="UserResources/images/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Selina"></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="col-lg-4 col-xlg-3">
                        <div class="card">
                            <img class="card-img-top img-responsive" src="UserResources/images/img1.jpg" alt="Card image cap">
                            <div class="card-body">
                            ...
                            <div class="msg-widget m-t-20">
                                ...
                                <div class="msg-item">
                                    ...
                                    <div class="m-t-20 d-flex">
                                        <div class="m-pic m-r-20"><img src="UserResources/images/profile.png" alt="user"></div>
                                        <div class="author">
                                ...
                                <div class="msg-item">
                                    ...
                                    <div class="m-t-20 d-flex">
                                        <div class="m-pic m-r-20"><img src="UserResources/images/4.jpg" alt="user"></div>
                                        <div class="author">
                                            <h5 class="m-b-0">Mark Freeman</h5>
                                            <p class="text-muted font-14">Today 04:12 PM</p>
                                        </div>
                                ...
                                <div class="msg-item">
                                    ...
                                    <div class="m-t-20 d-flex">
                                        <div class="m-pic m-r-20"><img src="UserResources/images/2.jpg" alt="user"></div>
                                        <div class="author">
                                            <h5 class="m-b-0">Mark Freeman</h5>
                                            <p class="text-muted font-14">Today 04:12 PM</p>
                                        </div>
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img src="UserResources/images/1.jpg" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="UserResources/images/2.jpg" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="UserResources/images/3.jpg" alt="user-img" class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="UserResources/images/4.jpg" alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="UserResources/images/5.jpg" alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="UserResources/images/6.jpg" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="UserResources/images/7.jpg" alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="UserResources/images/8.jpg" alt="user-img" class="img-circle"> <span>Pwandeep rajan <small class="text-success">online</small></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <script src="UserResources/js/perfect-scrollbar.jquery.min.js"></script>
    <!--Wave Effects -->
    <script src="UserResources/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="UserResources/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    ...
    <script src="UserResources/js/jquery.sparkline.min.js"></script>
    <!--morris JavaScript -->
    <script src="UserResources/js/chartist.min.js"></script>
    <script src="UserResources/js/chartist-plugin-tooltip.min.js"></script>
    <!--c3 JavaScript -->
    <script src="UserResources/js/d3.min.js"></script>
    <script src="UserResources/js/c3.min.js"></script>
    <!-- Popup message jquery -->
    <script src="UserResources/js/jquery.toast.js"></script>
    <!-- Chart JS -->
    <script src="UserResources/js/dashboard1.js"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
    <script src="UserResources/js/jQuery.style.switcher.js"></script>
</body>
