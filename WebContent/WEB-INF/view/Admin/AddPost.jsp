                    ...
                    <div class="col-md-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">Add Post</h5>
                                <%@taglib uri="http://www.springframework.org/tags/form" prefix="c"%>
                                <c:form action="insertPost.html" modelAttribute="postVO">
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3 mb-0 text-left text-sm-right" for="samplePhone">Post Name</label>
                                        <div class="col-sm-9">
                                            <c:input type="text" name="samplePhone" class="form-control mb-0" placeholder="Enter Post Title" path="postName"/>
                                        </div>
                                        <!-- /.col-sm-9 -->
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <c:textarea type="text" name="postdescription" class="form-control mb-0" placeholder="Enter Post Description" path="postDescription"/>
                                        </div>
                                        <!-- /.col-sm-9 -->
                                    </div>
