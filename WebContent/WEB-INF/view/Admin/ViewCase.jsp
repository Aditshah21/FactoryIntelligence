        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">View Case</h6>
                </div>
            </div>
            <!-- /.page-title -->
            <!-- =================================== -->
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-heading clearfix">
                                <h5>All Cases</h5><a href="CaseExportCSV.html">Download CSV</a>
                            </div>
                            <!-- /.widget-heading -->
                                ...
                                <table class="table table-editable table-responsive" data-toggle="datatables">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-editable>Case Name</th>
                                            <th data-editable>Case Description</th>
                                        </tr>
                                    </thead>
                                    <c:forEach items="${sessionScope.searchcase}" var="data">
                                    <tbody>
                                        <tr>
                                            <td>${data.id}</td>
                                            <td>${data.caseName}</td>
                                            <td>${data.caseDescription}</td>
											<td><a href="editCase.html?id=${data.id}">Update</a></td>
											<td><a href="deleteCase.html?id=${data.id}">Delete</a></td>
                                        </tr>
                                    </tbody>
                                    </c:forEach>
                                </table>
