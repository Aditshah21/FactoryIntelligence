        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Upload Picture!</h6>
                </div>
                <!-- /.page-title-left -->
                <!-- /.page-title-right -->
            </div>
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <p class="text-muted">Upload Multiple Image Here!</p>
                                <%@taglib uri="http://www.springframework.org/tags/form"  prefix="c" %>
                                <c:form action="insertPic.html" modelAttribute="testingVO" method="post" enctype="multipart/form-data">
