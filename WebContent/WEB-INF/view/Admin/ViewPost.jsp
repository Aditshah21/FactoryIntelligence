        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">View Post</h6>
                </div>
            </div>
            <!-- /.page-title -->
            <!-- =================================== -->
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-heading clearfix">
                                <h5>All Posts</h5><a href="PostExportCSV.html">Download CSV</a>
                            </div>
                            <!-- /.widget-heading -->
                                ...
                                <table class="table table-editable table-responsive" data-toggle="datatables">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-editable>Post Name</th>
                                            <th data-editable>Post Description</th>
                                        </tr>
                                    </thead>
                                    <c:forEach items="${sessionScope.searchpost}" var="data">
                                    <tbody>
                                        <tr>
                                            <td>${data.id}</td>
                                            <td>${data.postName}</td>
                                            <td>${data.postDescription}</td>
											<td><a href="editPost.html?id=${data.id}">Update</a></td>
											<td><a href="deletePost.html?id=${data.id}">Delete</a></td>
                                        </tr>
                                    </tbody>
                                    </c:forEach>
                                </table>
