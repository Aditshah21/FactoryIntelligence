        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Browse Your Image</h6>
                </div>
                <!-- /.page-title-left -->
                <!-- /.page-title-right -->
            </div>
...
function callWebService()
	{
		...
		ajax.open("get","http://127.0.0.1:5000//?imageName="+file.value.replace(/C:\\fakepath\\/,''),true);
		ajax.send();
	}
</script>            
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <p class="text-muted">Browse Image</p>
                                       <input type="file" id="uploadfile">
 						           <div align="left" class="ml-auto col-sm-9 no-padding">
                                        <button class="btn btn-primary" type="submit" onclick="callWebService()">Submit</button>
                                   </div>
                            </div>
                            <!-- /.widget-body -->
                        </div>
