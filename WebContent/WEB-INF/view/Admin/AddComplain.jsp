        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Manage Complains</h6>
                </div>
                <!-- /.page-title-right -->
            </div>
            <!-- /.page-title -->
                    ...
                    <div class="col-md-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">Add Complain</h5>
                                <%@taglib uri="http://www.springframework.org/tags/form" prefix="c"%>
                                <c:form action="insertComplain.html" modelAttribute="complainVO">
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3 mb-0 text-left text-sm-right" for="samplePhone">Complain Name</label>
                                        <div class="col-sm-9">
                                            <c:input type="text" name="complainName" class="form-control mb-0" placeholder="Enter Complain Title" path="complainName"/>
                                        </div>
                                        <!-- /.col-sm-9 -->
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <c:textarea type="text" name="casedescription" class="form-control mb-0" placeholder="Enter Complain Description" path="complainDescription"/>
                                        </div>
                                        <!-- /.col-sm-9 -->
                                    </div>
