        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">View Complains</h6>
                </div>
            </div>
            <!-- /.page-title -->
            <!-- =================================== -->
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-heading clearfix">
                                <h5>All Complains</h5><a href="ComplainExportCSV.html">Download CSV</a>
                            </div>
                            <!-- /.widget-heading -->
                                ...
                                <table class="table table-editable table-responsive" data-toggle="datatables">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-editable>Complain Name</th>
                                            <th data-editable>Complain Description</th>
                                        </tr>
                                    </thead>
                                    <c:forEach items="${sessionScope.searchComplain}" var="data">
                                    <tbody>
                                        <tr>
                                            <td>${data.id}</td>
                                            <td>${data.complainName}</td>
                                            <td>${data.complainDescription}</td>
											<td><a href="editComplain.html?id=${data.id}">Update</a></td>
											<td><a href="deleteComplain.html?id=${data.id}">Delete</a></td>
                                        </tr>
                                    </tbody>
                                    </c:forEach>
                                </table>
