        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Manage Case</h6>
                </div>
                <!-- /.page-title-right -->
            </div>
            <!-- /.page-title -->
                    ...
                    <div class="col-md-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">Add Case</h5>
                                <%@taglib uri="http://www.springframework.org/tags/form" prefix="c"%>
                                <c:form action="insertCase.html" modelAttribute="caseVO">
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3 mb-0 text-left text-sm-right" for="samplePhone">Case Name</label>
                                        <div class="col-sm-9">
                                            <c:input type="text" name="caseName" class="form-control mb-0" placeholder="Enter Case Title" path="caseName"/>
                                        </div>
                                        <!-- /.col-sm-9 -->
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <c:textarea type="text" name="casedescription" class="form-control mb-0" placeholder="Enter Case Description" path="caseDescription"/>
                                        </div>
                                        <!-- /.col-sm-9 -->
                                    </div>
