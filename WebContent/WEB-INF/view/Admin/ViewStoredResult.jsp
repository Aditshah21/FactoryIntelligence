        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Showing Detected Images</h6>
                </div>
                <!-- /.page-title-right -->
            </div>
            <!-- /.page-title -->
                    ...
                    <div class="col-md-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">Detected Images</h5>
            <li><%-- ${image.originalFilename} --%>
            <img width="100" src="<c:url value="/WebContent/images/"/>"/>
            </li>
                            </div>
                            <!-- /.widget-body -->
                        </div>
