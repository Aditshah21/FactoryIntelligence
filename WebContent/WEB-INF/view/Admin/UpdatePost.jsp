        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Manage Post</h6>
                </div>
                <!-- /.page-title-right -->
            </div>
            <!-- /.page-title -->
                    ...
                    <div class="col-md-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">Update Post</h5>
                                <%@taglib uri="http://www.springframework.org/tags/form" prefix="c"%>
                                <%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="d"%>
                               <d:forEach items="${sessionScope.updatepost}" var="data">
                                <c:form action="updatePost.html" modelAttribute="postVO">
                                <c:hidden value="${data.id}" name="id" path="id"/>
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3 mb-0 text-left text-sm-right" for="samplePhone">Post Name</label>
                                        <div class="col-sm-9">
                                            <c:input type="text" name="samplePhone" class="form-control mb-0" value="${data.postName}" placeholder="Enter Post Title" path="postName"/>
                                        </div>
                                        <!-- /.col-sm-9 -->
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3 mb-0 text-left text-sm-right" for="samplePhoneExt">Post Description</label>
                                        <div class="col-sm-9">
                                            <c:textarea type="text" name="postdescription" class="form-control mb-0" value="${data.postDescription}" placeholder="Enter Post Description" path="postDescription"/>
                                        </div>
                                        <!-- /.col-sm-9 -->
                                    </div>
