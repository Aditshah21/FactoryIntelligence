...
exports.env = {
  isWebKit: 'WebkitAppearance' in document.htmlcumentElement.style,
  supportsTouch: (('ontouchstart' in window) || window.htmlcumentTouch && document instanceof window.htmlcumentTouch),
